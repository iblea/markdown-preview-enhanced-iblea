...
- Added an option to encode images displayed in the preview window to base64, making it easier to copy/paste images.
  - `"markdown-preview-enhanced-iblea.previewImageToBase64": true`
